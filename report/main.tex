...
% TODO (Mario): LogNormal fit (Basic), MDN-based dynamic arrivals (Advanced),
% evaluation: inter-arrival error, daily arrival profile.
tbd.
...
% TODO (all, per lecture 06 final tasks): one subsection per package, name
% first. Suggested structure:
% \subsection{Experimental Setup and Metrics (…)} — avg cycle time, avg
%   resource occupation (relative to availability windows), (weighted)
%   resource fairness; >=10 seeds, warm-up, CIs.
% \subsection{Simple Policies and k-Batching (…)}
% \subsection{Advanced Policy I: … (…)}
% \subsection{Advanced Policy II: … (…)}
% \subsection{Management Question (…)} — "fire two employees":
%   criticality analysis + leave-two-out simulations.
tbd.
